...
def main():
    ...
    k_h = np.linspace(1e-4, 2.0, 200)  # [h/Mpc]
    ...
    print("Relative difference in linear matter power spectrum (P_inverted / P_normal - 1):")
    print("k [h/Mpc] range: " + str(k_h[0]) + " to " + str(k_h[-1]))
    print("Number of k points: " + str(len(k_h)))
