...
def main():
    ...
    # k grid: 200 points from 1e-4 to 2 h/Mpc
    ...
    print("k [h/Mpc] range: " + ("%.4e" % k_h[0]) + " to " + ("%.4e" % k_h[-1]))
    print("Minimum rel_diff: " + ("%.6e" % np.min(rel_diff)))
    print("Maximum rel_diff: " + ("%.6e" % np.max(rel_diff)))
