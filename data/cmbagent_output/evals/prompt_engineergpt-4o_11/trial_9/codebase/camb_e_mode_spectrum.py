# filename: codebase/camb_e_mode_spectrum.py
import camb
...
powers = results.get_cmb_power_spectra(pars, lmax=100, CMB_unit='muK')
EE_spectrum = powers['EE']

# Extract the E-mode power spectrum for l=2 to l=100
...
# Print the results
print("E-mode polarization power spectrum (l(l+1)C_l^{EE}/(2π)) in μK^2:")
print(df)