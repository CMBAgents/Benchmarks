...
powers = results.get_cmb_power_spectra(pars, lmax=3000, CMB_unit='muK')
totCL = powers['total']
...
print("The file contains multipole moments (l) from 2 to 3000 and the corresponding temperature power spectrum (TT) in units of microK^2.")
