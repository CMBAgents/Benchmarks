...
pars.set_cosmology(H0=H0, ombh2=ombh2, omch2=omch2, omk=omk, mnu=mnu, tau=tau)
...
print("The file contains multipole moments (l) from 2 to 3000 and the corresponding temperature power spectrum (TT) in microkelvin squared.")