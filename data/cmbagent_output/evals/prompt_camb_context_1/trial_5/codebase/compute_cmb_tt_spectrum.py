...
def compute_cmb_tt_spectrum():
    ...
    # Get the lensed scalar CMB power spectra (D_l = l(l+1)C_l/(2pi), muK^2)
    ...
    l_arr = np.arange(powers.shape[0])  # l = 0..3000
    l_vals = l_arr[2:3001]              # l = 2..3000
    TT_vals = powers[2:3001, 0]         # TT column
    ...
    print("Columns: l (multipole, 2..3000), TT (l(l+1)C_l^{TT}/(2pi) in muK^2)")
    print("First 5 rows:")
    print(df.head())
    print("Last 5 rows:")
    print(df.tail())
