# filename: codebase/calculate_EE_power_spectrum.py
import camb
...
# Calculate l(l+1)C_l^{EE}/(2pi)
l = np.arange(2, EE_spectrum.size)
EE_power_spectrum = (l * (l + 1) * EE_spectrum[2:]) / (2 * np.pi)

# Save the results to a CSV file
data = pd.DataFrame({"l": l, "EE": EE_power_spectrum})
