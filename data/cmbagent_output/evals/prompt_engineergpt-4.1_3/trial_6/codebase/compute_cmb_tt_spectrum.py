...
def compute_cmb_tt_spectrum():
    ...
    'l' (multipole moment) and 'TT' (raw temperature power spectrum in microkelvin^2).
    ...
    Output:
        Saves 'data/result.csv' with columns:
            ...
            TT: Raw temperature power spectrum (microkelvin^2)
    ...
    TT = cl[lmin:lmax + 1, 0]  # TT spectrum in microkelvin^2
    ...
    print("\nLast 5 rows:")
    print(df.tail())
    print("\nUnits: TT in microkelvin^2, l is dimensionless.")
