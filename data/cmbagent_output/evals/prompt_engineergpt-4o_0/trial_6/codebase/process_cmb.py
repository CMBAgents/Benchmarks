# filename: codebase/process_cmb.py
import camb
...
print("The file contains multipole moments (l) from 2 to 3000 and the corresponding temperature power spectrum (TT) in microkelvin squared (μK²).")