...
# Compute the temperature power spectrum
l = np.arange(2, totCL.shape[0])
TT = totCL[2:, 0] * (l * (l + 1)) / (2 * np.pi)
...
print("The file contains two columns: 'l' (multipole moment) and 'TT' (temperature power spectrum in μK^2).")