...
def calculate_cmb_power_spectrum():
    ...
    # Ensure pandas options are set for clear, non-truncated output for these prints
    # These are set in if __name__ == '__main__' block, which is good.
    ...
    print("Min TT: " + str(df_results['TT'].min()))  # muK^2
    print("Max TT: " + str(df_results['TT'].max()))  # muK^2
    print("Mean TT: " + str(df_results['TT'].mean()))  # muK^2
