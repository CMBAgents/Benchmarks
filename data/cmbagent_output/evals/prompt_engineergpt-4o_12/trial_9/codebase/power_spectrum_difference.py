# filename: codebase/power_spectrum_difference.py
import camb
...
# Function to get power spectrum for a given neutrino hierarchy
def get_power_spectrum(neutrino_hierarchy):
    pars = camb.CAMBparams()
    pars.set_cosmology(H0=H0, ombh2=ombh2, omch2=omch2, mnu=sum_mnu, omk=0, neutrino_hierarchy=neutrino_hierarchy)
...
# Get power spectra for normal and inverted hierarchies
pk_normal = get_power_spectrum('normal')
pk_inverted = get_power_spectrum('inverted')
