...
def get_matter_power_spectrum(hierarchy):
    ...
    Returns:
    np.ndarray: Linear matter power spectrum for the given hierarchy.
    """
    pars = camb.CAMBparams()
    pars.set_cosmology(H0=H0, ombh2=ombh2, omch2=omch2, mnu=mnu, omk=0, neutrino_hierarchy=hierarchy)
    ...
    return pk[0]  # Return the power spectrum at z=0
