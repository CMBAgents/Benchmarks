...
TT = totCL[2:, 0]  # TT power spectrum
...
print("The file contains multipole moments (l) from 2 to 3000 and the corresponding TT power spectrum in units of microkelvin squared.")