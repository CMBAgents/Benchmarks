...
cl = results.get_cmb_power_spectra(params, lmax=2000, CMB_unit='muK', raw_cl=True)

# Extract power spectra
cl_bb = cl['total'][:, 2]  # Lensed B-mode power spectrum
cl_pp = cl['lens_potential'][:, 0]  # CMB lensing potential power spectrum
...
# Pad residual lensing potential array
max_l = len(cl_pp)  # Updated from 2000 to match the length of cl_pp
